...
case class XilinxSophiaLakeMIGParams(
  address : Seq[AddressSet]
)

class XilinxSophiaLakeMIGPads(depth : BigInt) extends SophiaLakeMIGIODDR(depth) {
  def this(c : XilinxSophiaLakeMIGParams) {
    this(AddressRange.fromSets(c.address).head.size)
  }
}

class XilinxSophiaLakeMIGIO(depth : BigInt) extends SophiaLakeMIGIODDR(depth) with SophiaLakeMIGIOClocksReset

class XilinxSophiaLakeMIGIsland(c : XilinxSophiaLakeMIGParams, val crossing: ClockCrossingType = AsynchronousCrossing(8))(implicit p: Parameters) extends LazyModule with CrossesToOnlyOneClockDomain {
  val ranges = AddressRange.fromSets(c.address)
  require (ranges.size == 1, "DDR range must be contiguous")
  val offset = ranges.head.base
  val depth = ranges.head.size
  require((depth<=0x10000000L),"SophiaLakeMIG supports upto 256 MB depth configuraton")
  ...
  class Impl extends LazyRawModuleImp(this) {
    val io = IO(new Bundle {
      val port = new XilinxSophiaLakeMIGIO(depth)
    })
    ...
    val blackbox = withClockAndReset(childClock, childReset) { Module(new SophiaLakeMIG(depth)) }
...
class XilinxSophiaLakeMIG(c : XilinxSophiaLakeMIGParams, crossing: ClockCrossingType = AsynchronousCrossing(8))(implicit p: Parameters) extends LazyModule {
  val ranges = AddressRange.fromSets(c.address)
  val depth = ranges.head.size
  ...
  val island  = LazyModule(new XilinxSophiaLakeMIGIsland(c, crossing))
...
// Black Box
class SophiaLakeMIGIODDR(depth : BigInt) extends Bundle {
  require((depth<=0x1000000000L),"SophiaLakeMIGIODDR supports upto 1G depth configuraton")
...
trait SophiaLakeMIGIOClocksReset extends Bundle {
  //inputs
...
class SophiaLakeMIG(depth : BigInt)(implicit val p:Parameters) extends BlackBox
{
  require((depth<=0x1000000000L),"SophiaLakeMIG supports upto 1G depth configuraton")

  val io = IO(new SophiaLakeMIGIODDR(depth) with SophiaLakeMIGIOClocksReset {
    // User interface signals
  ...
  val migprj = """{<?xml version='1.0' encoding='UTF-8'?>
    ...
    <Project NoOfControllers="1" >
      ...
      <Controller number="0" >
        ...
        <PinSelection>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="V5" SLEW="" VCCAUX_IO="" name="ddr3_addr[0]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="U3" SLEW="" VCCAUX_IO="" name="ddr3_addr[10]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="AB2" SLEW="" VCCAUX_IO="" name="ddr3_addr[11]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="AA3" SLEW="" VCCAUX_IO="" name="ddr3_addr[12]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="W2" SLEW="" VCCAUX_IO="" name="ddr3_addr[13]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="W5" SLEW="" VCCAUX_IO="" name="ddr3_addr[14]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="Y1" SLEW="" VCCAUX_IO="" name="ddr3_addr[1]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="V4" SLEW="" VCCAUX_IO="" name="ddr3_addr[2]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="Y4" SLEW="" VCCAUX_IO="" name="ddr3_addr[3]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="AA1" SLEW="" VCCAUX_IO="" name="ddr3_addr[4]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="AA4" SLEW="" VCCAUX_IO="" name="ddr3_addr[5]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="AB1" SLEW="" VCCAUX_IO="" name="ddr3_addr[6]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="Y6" SLEW="" VCCAUX_IO="" name="ddr3_addr[7]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="AB5" SLEW="" VCCAUX_IO="" name="ddr3_addr[8]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="W1" SLEW="" VCCAUX_IO="" name="ddr3_addr[9]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="W4" SLEW="" VCCAUX_IO="" name="ddr3_ba[0]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="AB3" SLEW="" VCCAUX_IO="" name="ddr3_ba[1]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="U5" SLEW="" VCCAUX_IO="" name="ddr3_ba[2]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="T5" SLEW="" VCCAUX_IO="" name="ddr3_cas_n"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="R2" SLEW="" VCCAUX_IO="" name="ddr3_ck_n[0]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="R3" SLEW="" VCCAUX_IO="" name="ddr3_ck_p[0]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="W6" SLEW="" VCCAUX_IO="" name="ddr3_cke[0]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="V2" SLEW="" VCCAUX_IO="" name="ddr3_cs_n[0]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="P2" SLEW="" VCCAUX_IO="" name="ddr3_dm[0]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="J6" SLEW="" VCCAUX_IO="" name="ddr3_dm[1]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="C2" SLEW="" VCCAUX_IO="" name="ddr3_dm[2]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="G3" SLEW="" VCCAUX_IO="" name="ddr3_dm[3]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="N4" SLEW="" VCCAUX_IO="" name="ddr3_dq[0]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="L5" SLEW="" VCCAUX_IO="" name="ddr3_dq[10]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="K4" SLEW="" VCCAUX_IO="" name="ddr3_dq[11]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="L3" SLEW="" VCCAUX_IO="" name="ddr3_dq[12]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="M2" SLEW="" VCCAUX_IO="" name="ddr3_dq[13]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="M3" SLEW="" VCCAUX_IO="" name="ddr3_dq[14]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="K3" SLEW="" VCCAUX_IO="" name="ddr3_dq[15]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="B1" SLEW="" VCCAUX_IO="" name="ddr3_dq[16]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="F1" SLEW="" VCCAUX_IO="" name="ddr3_dq[17]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="A1" SLEW="" VCCAUX_IO="" name="ddr3_dq[18]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="E2" SLEW="" VCCAUX_IO="" name="ddr3_dq[19]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="P1" SLEW="" VCCAUX_IO="" name="ddr3_dq[1]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="D2" SLEW="" VCCAUX_IO="" name="ddr3_dq[20]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="G1" SLEW="" VCCAUX_IO="" name="ddr3_dq[21]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="B2" SLEW="" VCCAUX_IO="" name="ddr3_dq[22]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="F3" SLEW="" VCCAUX_IO="" name="ddr3_dq[23]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="K1" SLEW="" VCCAUX_IO="" name="ddr3_dq[24]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="J5" SLEW="" VCCAUX_IO="" name="ddr3_dq[25]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="H2" SLEW="" VCCAUX_IO="" name="ddr3_dq[26]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="H5" SLEW="" VCCAUX_IO="" name="ddr3_dq[27]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="G2" SLEW="" VCCAUX_IO="" name="ddr3_dq[28]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="H4" SLEW="" VCCAUX_IO="" name="ddr3_dq[29]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="N5" SLEW="" VCCAUX_IO="" name="ddr3_dq[2]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="J1" SLEW="" VCCAUX_IO="" name="ddr3_dq[30]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="H3" SLEW="" VCCAUX_IO="" name="ddr3_dq[31]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="R1" SLEW="" VCCAUX_IO="" name="ddr3_dq[3]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="M5" SLEW="" VCCAUX_IO="" name="ddr3_dq[4]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="P6" SLEW="" VCCAUX_IO="" name="ddr3_dq[5]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="M6" SLEW="" VCCAUX_IO="" name="ddr3_dq[6]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="N2" SLEW="" VCCAUX_IO="" name="ddr3_dq[7]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="K6" SLEW="" VCCAUX_IO="" name="ddr3_dq[8]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="J4" SLEW="" VCCAUX_IO="" name="ddr3_dq[9]"/>
          <Pin IN_TERM="" IOSTANDARD="DIFF_SSTL135" PADName="P4" SLEW="" VCCAUX_IO="" name="ddr3_dqs_n[0]"/>
          <Pin IN_TERM="" IOSTANDARD="DIFF_SSTL135" PADName="L1" SLEW="" VCCAUX_IO="" name="ddr3_dqs_n[1]"/>
          <Pin IN_TERM="" IOSTANDARD="DIFF_SSTL135" PADName="D1" SLEW="" VCCAUX_IO="" name="ddr3_dqs_n[2]"/>
          <Pin IN_TERM="" IOSTANDARD="DIFF_SSTL135" PADName="J2" SLEW="" VCCAUX_IO="" name="ddr3_dqs_n[3]"/>
          <Pin IN_TERM="" IOSTANDARD="DIFF_SSTL135" PADName="P5" SLEW="" VCCAUX_IO="" name="ddr3_dqs_p[0]"/>
          <Pin IN_TERM="" IOSTANDARD="DIFF_SSTL135" PADName="M1" SLEW="" VCCAUX_IO="" name="ddr3_dqs_p[1]"/>
          <Pin IN_TERM="" IOSTANDARD="DIFF_SSTL135" PADName="E1" SLEW="" VCCAUX_IO="" name="ddr3_dqs_p[2]"/>
          <Pin IN_TERM="" IOSTANDARD="DIFF_SSTL135" PADName="K2" SLEW="" VCCAUX_IO="" name="ddr3_dqs_p[3]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="U2" SLEW="" VCCAUX_IO="" name="ddr3_odt[0]"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="R6" SLEW="" VCCAUX_IO="" name="ddr3_ras_n"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="Y8" SLEW="" VCCAUX_IO="" name="ddr3_reset_n"/>
          <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="U6" SLEW="" VCCAUX_IO="" name="ddr3_we_n"/>
        </PinSelection>
        <System_Control>
  ...
  val migprjname = """{/SophiaLakeMIG.prj}"""
  val modulename = """SophiaLakeMIG"""
