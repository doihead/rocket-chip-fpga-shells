...
//   require((depth<=0x10000000L),"BoraLakeMIG supports upto 256 MB depth configuraton")
...
//   require((depth<=0x10000000L),"BoraLakeMIGIODDR supports upto 256 MB depth configuraton")
